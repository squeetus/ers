...
Node.prototype.render = function(x, y, r){
	...
	if(this.type != "Hallway")
	    ...
	    this.bbox.on(dbltap, function(e) {
		console.log("Tapped room bbox. (" + this.id + ")");
	    });
...
function loadGraph(data) {
    ...
    var xscale = max_x - min_x;
    var yscale = max_y - min_y;
    ...
    for(var i = 0; i < node_data.length; i++) {
        ...
        console.log("scaled: ", (max_x - node_data[i]["x_pos"]) / xscale, (max_y - node_data[i]["y_pos"]) / yscale);
