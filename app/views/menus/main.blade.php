...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="mainMenu">
	    ...
	    <li {{{ Route::getCurrentRoute()->getPath() === "command_center" ? "class=active" : "" }}}><a href="{{{ URL::to('/command_center') }}}"><span class="glyphicon glyphicon-dashboard"></span>Command Center</a></li>
